...
(function($) {
    ...
    * ---------------------------------------------------- */ 
    ...
    var clMobileMenu = function() {
       // alert('toggle..');
        ...
        var navWrap = $('.header__nav-wrap'),
            ...
            siteBody = $('body');
            $(document).on('click','.header__toggle-menu', function(e) {
         ...
         $(document).on('click','.header__overlay-close', function(e) {
    ...
    $(document).on('click','.header__nav .has-children a', function (e) {
